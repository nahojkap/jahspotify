...
public class PlaylistController extends BaseController
{
    ...
    public JSTreeNode retrieveLibraryAjax(final HttpServletResponse httpServletResponse)
    {
        ...
        final List<jahspotify.media.LibraryEntry> children = library.getEntries();
        for (jahspotify.media.LibraryEntry child : children)
        {
    ...
    private JSTreeNode processEntry(jahspotify.media.LibraryEntry entry)
    {
        ...
        for (jahspotify.media.LibraryEntry subEntry : entry.getSubEntries())
        {
