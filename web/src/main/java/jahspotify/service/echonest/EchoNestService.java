...
import jahspotify.service.nuances.*;
...
public class EchoNestService
{
     ...
     */
    public Playlist retrieveDynamicPlaylist(String artist, List<Mood> moods, List<Style> styles) throws EchoNestException
    {
     ...
     * @throws EchoNestException
     */
    public Playlist updateDynamicPlaylist(Playlist playlist) throws EchoNestException
    {
        return _echoNestApi.getNextInDynamicPlaylist(playlist.getSession());
    }
