...
public class Media
{
     ...
     *
     * @return A decimal value between 0.0 and 1.0 or {@String Float#NaN} if not available.
     */
     ...
     *
     * @param popularity A decimal value between 0.0 and 1.0 or {@String Float#NaN}.
